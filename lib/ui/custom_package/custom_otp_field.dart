  ...
  Widget buildTextField(BuildContext context, int i) {
    ...
    return Container(
      ...
      child: TextField(
        ...
        onTap: (){
          print("on tap is invoked");
          _textControllers[i]!.selection = TextSelection.fromPosition(TextPosition(offset: _textControllers[i]!.text.length));
        },
        ...
        onChanged: (String str) {
          print("onChanged is invoked $str");
